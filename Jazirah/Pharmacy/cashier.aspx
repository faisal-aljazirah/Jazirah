<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pharmacy/PH.Master" CodeBehind="cashier.aspx.vb" Inherits="Jazirah.cashier" %>
                    ...
                    <table class="table tablelist table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr id="row<%#DataBinder.Eval(Container.DataItem, "TransactionNo")%>">
					          ...
					          <td>
                                  <button type="button" onclick="javascript:showCashier(<%#DataBinder.Eval(Container.DataItem, "TransactionNo")%>);" class="btn btn-sm btn-success"><%=btnPay%></button>
                                  <button type="button" onclick="javascript:<%#AllowReturn(DataBinder.Eval(Container.DataItem, "TransactionNo"))%>" class="btn btn-sm btn-danger"><%=btnReturn%></button>
					          </td>
                            </tr>
                            </ItemTemplate>
                            </asp:Repeater>
  ...
  <script type="text/javascript">
      ...
      function calculateInsurance(c) {
          ...
          if ($('.insurance' + c + ' .total_I').length > 0) {
              ...
              $.each($('.insurance' + c + ' .discount_I'), function (k, v) {
                  discount = discount + parseFloat(v.value);
              });
              $.each($('.insurance' + c + ' .total_I'), function (k, v) {
                  total = total + parseFloat(v.value);
              });
              $('#coveredCash' + c).val(parseFloat(total, 10).toFixed(2));
              $('#total_I_' + c).html(parseFloat(total, 10).toFixed(2));
              $('#price_I_' + c).html(parseFloat(price, 10).toFixed(2));
              $('#discount_I_' + c).html(parseFloat(discount, 10).toFixed(2));
          } else {
              $('#coveredCash' + c).val(0);
              $('#total_I_' + c).html("0.00");
              $('#price_I_' + c).html("0.00");
              $('#discount_I_' + c).html("0.00");
          }
          ...
          if ($('.coverage').length > 0) {
              ...
              $('#deductionCash' + c).val(parseFloat(coverage, 10).toFixed(2));
          } else {
              $('#totalCovered' + c).html('0.00');
              $('#deductionCash' + c).val(0);
          }
      ...
      function calculateCash(c) {
          ...
          if ($('.cash' + c + ' .total_C').length > 0) {
              ...
              $.each($('.cash' + c + ' .discount_C'), function (k, v) {
                  discount = discount + parseFloat(v.value);
              });
              ...
              $('#discount_C_' + c).html(parseFloat(discount, 10).toFixed(2));
          } else {
              $('#nonCoveredCash' + c).val(0);
              $('#total_C_' + c).html("0.00");
              $('#price_C_' + c).html("0.00");
              $('#discount_C_' + c).html("0.00");
          }
