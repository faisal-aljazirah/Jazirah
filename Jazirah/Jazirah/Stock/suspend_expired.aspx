<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Stock/ST.Master" CodeBehind="suspend_expired.aspx.vb" Inherits="Jazirah.suspend_expired" %>
    ...
    <div class="col-xs-4">
        <div class="card p-1">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-sm btn-success full-width" onclick="javascript:showModal('viewSExpired', '{lngTransaction: 0, IsOut: false}', '#mdlAlpha')">Suspend Expired Items</button>
                    </div>
                    <div class="col-md-6">
                        <button type="button" class="btn btn-sm btn-success full-width" onclick="javascript:showModal('viewSExpired', '{lngTransaction: 0, IsOut: true}', '#mdlAlpha')">Resume Expired Items</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2"><button type="button" id="btnSearch" class="btn btn-sm btn-outline-orange full-width" onclick="javascript:fillSExpired();"><%=btnSearch%></button></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-body collapse in p-1">
                <div class="table-responsive" id="tblExpired">
