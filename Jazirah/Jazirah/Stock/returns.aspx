<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Stock/ST.Master" CodeBehind="returns.aspx.vb" Inherits="Jazirah.returns1" %>
    ...
    <div class="col-xs-12">
        <div class="card p-1">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-7"><input type="text" class="form-control form-control-sm input-sm" id="txtInvoicesSearch" placeholder="" value="" /></div>
