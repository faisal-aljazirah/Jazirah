...
Public Class expired
    ...
    Private Sub expired_Init(sender As Object, e As EventArgs) Handles Me.Init
        ' User Options
    ...
    Private Sub LoadPermissions()
        ...
        Dim warehouse As XmlNodeList = doc.SelectNodes("Permissions/Warehouses/User[@ID='" & strUserName & "']/Expired")
    ...
    Sub loadLanguage()
        Select Case ByteLanguage
            Case 2
                DataLang = "Ar"
                Title = "المخزون | الأصناف المنتهية"
                'Variables
                strWait = "فضلا انتظر..."
                'Buttons
                btnSearch = "بحث"
