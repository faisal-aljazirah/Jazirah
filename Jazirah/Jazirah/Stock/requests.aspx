<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Stock/ST.Master" CodeBehind="requests.aspx.vb" Inherits="Jazirah.requests" %>
    ...
    <div class="col-xs-2">
        <div class="card p-1">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-sm btn-success full-width" disabled="disabled" onclick="javascript:showModal('viewTransfer', '{lngTransaction: 0}', '#mdlAlpha')">New Transfer</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-1"><button type="button" id="btnSearch" class="btn btn-sm btn-outline-orange full-width" onclick="javascript:fillRequests();"><%=btnSearch%></button></div>
                        <div class="col-md-1"><button type="button" id="btnAdvance" class="btn btn-sm btn-outline-orange full-width" disabled="disabled" onclick="javascript:fillRequests();"><%=btnAdvanced%></button></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-body collapse in p-1">
                <div class="table-responsive" id="tblRequests">
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterPlaceHolder" runat="server">
  ...
  <script type="text/javascript">
      ...
      function fillRequests() {
          $('#tblRequests').html('<div class="bg-grey text-md-center text-bold-300 bg-lighten-4 pt-2 pb-2"><img src="../app-assets/images/icons/spinner.gif" /> <%=strWait %></div>');
          ...
          $.ajax({
              type: 'POST',
              url: '../Stock/ajax.aspx/fillRequests',
