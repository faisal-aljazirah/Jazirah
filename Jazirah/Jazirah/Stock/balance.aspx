<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Stock/ST.Master" CodeBehind="balance.aspx.vb" Inherits="Jazirah.balance1" %>
  ...
  <script type="text/javascript">
      ...
      function fillBalance() {
          ...
          $.ajax({
              ...
              data: '{strItem: "' + titem + '", dateTransaction: "' + tdate + '", byteWarehouse: "' + twarehouse + '"}',
              contentType: 'application/json; charset=utf-8',
              dataType: 'json',
              success: function (response) {
                  if (response.d.substr(0, 4) == 'Err:') {
