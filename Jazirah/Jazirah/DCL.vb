...
Namespace Conn
    ...
    Public Class XMLData
        ...
        Public Function CheckExist(ByVal XMLFile As String, ByVal NodeName As String, ByVal ElementName As String, ByVal ElementValue As String, Optional Attribute As String = "") As Boolean
            Try
