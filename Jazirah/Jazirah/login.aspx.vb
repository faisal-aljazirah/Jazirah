    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.Form("submit") = "1" Then
            ...
            If UserName <> "" And UserPass <> "" Then
                ...
                Dim strUserName As String = sh.AuthenticateUser(UserName, UserPass)
                If strUserName.ToLower = UserName.ToLower Then
                    Dim login As New Share.User
                    login.ApplyUserLogin(strUserName, RememberMe)
                Else
                    msg.Visible = True
                End If
            End If
