...
Public Class r_sales
    Inherits System.Web.UI.Page
    Dim dcl As New DCL.Conn.DataClassLayer
    Public DataLang As String
    Public searchWord, btnFilter, Both, PaymentType, dte, InvType, byUser, byDoctor, byInvType, doct As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("r_sales_col") Is Nothing Or Session("r_sales_col") = "" Then
            'selectedColumns = "2,4,6,9,13,14,15,16"
