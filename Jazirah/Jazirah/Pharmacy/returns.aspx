<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pharmacy/PH.Master" CodeBehind="returns.aspx.vb" Inherits="Jazirah.returns" %>
                    ...
                    <table class="table tablelist table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr id="row<%#DataBinder.Eval(Container.DataItem, "TransactionNo")%>">
					          ...
					          <td>
                                  <button type="button" onclick="javascript:viewVoucher(<%#DataBinder.Eval(Container.DataItem, "TransactionNo")%>);" class="btn btn-sm btn-primary"><%=btnView%></button>
					          </td>
                            </tr>
                            </ItemTemplate>
                            </asp:Repeater>
