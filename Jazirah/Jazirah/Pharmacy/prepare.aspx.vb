...
Public Class prepare
    ...
    Function getActiveDoctorList1(ByVal Func As String) As String
        ...
        '    str = str & "<label class=""btn btn-secondary btn-sm " & active & """ onclick=""javascript:" & Func & "();""><input type=""radio"" value=""0"" name=""options"" " & checked & "> " & ds.Tables(0).Rows(I).Item("strContact" & DataLang) & "</label>"
        'Next
