...
Public Class checkout
    ...
    Function getActiveDoctorList1(ByVal Func As String) As String
        Dim str As String = ""
        str = str & "<div class=""btn-group btn-group-toggle"" data-toggle=""buttons"">"
        str = str & "<label class=""btn btn-primary btn-sm"" onclick=""javascript:" & Func & "('','','');fillDepartments1();fillDoctors1(0);$('#txtOrdersSearch1').val('');""><input type=""radio"" value=""0"" name=""options""> " & All & "</label>"
        Dim ds As DataSet
        Dim where As String
        ...
        For I = 0 To ds.Tables(0).Rows.Count - 1
            ...
            str = str & "<label class=""btn btn-secondary btn-sm " & active & """ onclick=""javascript:" & Func & "(''," & ds.Tables(0).Rows(I).Item("lngContact") & ",'');""><input type=""radio"" value=""0"" name=""options"" " & checked & "> " & ds.Tables(0).Rows(I).Item("strContact" & DataLang) & "</label>"
        Next
        'str = str & "<label class=""btn btn-primary btn-sm"" onclick=""javascript:" & Func & "($('#drpDepartments1').val(), $('#drpDoctors1').val(), $('#txtOrdersSearch1').val());""><input type=""radio"" value=""0"" name=""options""> Refresh </label>"
        str = str & "<label class=""btn btn-primary btn-sm"" onclick=""javascript:" & Func & "('', '', '');""><input type=""radio"" value=""0"" name=""options""> Refresh </label>"
        str = str & "</div>"
        Return str
    End Function
