        ...
        If (Not (Request.QueryString("t") Is Nothing)) And (Not (Request.QueryString("i") Is Nothing)) And (Not (Request.QueryString("e") Is Nothing)) Then
            ...
            Try
                ...
                If dsTrans.Tables(0).Rows.Count > 0 Then
                    ...
                    If CBool(dsTrans.Tables(0).Rows(0).Item("bSex")) = True Then Sex = "M" Else Sex = "F"
                    For Each item As String In Items
                        ...
                        If dsDose.Tables(0).Rows.Count > 0 Then
                            If counter > 0 Then body = body & "<P style=""page-break-before: always"">"
                            body = body & "<table>"
                    ...
                    Next
                End If
                divBody.InnerHtml = body & "<script type=""text/javascript"">window.print();window.close();</script>"
